...
public class Shooter extends SubsystemBase {
  ...
  public Shooter(Telemetry telemetry, final HardwareMap hardwareMap) {
    ...
    //        backShooter.setVelocityPIDFCoefficients(Constants.SHOOTER_P.value,
    // Constants.SHOOTER_I.value, Constants.SHOOTER_D.value, Constants.SHOOTER_F.value);
    //        frontShooter.setVelocityPIDFCoefficients(Constants.SHOOTER_P.value,
    // Constants.SHOOTER_I.value, Constants.SHOOTER_D.value,Constants.SHOOTER_F.value);
