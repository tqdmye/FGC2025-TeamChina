...
public class FGCTeleOp extends CommandOpMode {
    ...
    public void initialize() {
        ...
        gamepadEx1
                ...
                .whenPressed(new ConditionalCommand(new InstantCommand(()->++frontCount),
                        new InstantCommand(this::nothing),
                        ()->shooter.frontShooter.getVelocity()+frontCount*50<=2400));

        gamepadEx1
                .getGamepadButton(GamepadKeys.Button.DPAD_DOWN)
                .whenPressed(
                        new ConditionalCommand(new InstantCommand(()->--frontCount),
                                new InstantCommand(this::nothing),
                                ()->shooter.frontShooter.getVelocity()+frontCount*50>=500));
                                ...
                                new InstantCommand(
                                        () ->
                                                shooter.setShooterVelocity(
                                                        Constants.FRONT_SHOOTER_VELOCITY.value+frontCount*50,
                                                        shooter.frontShooter.getVelocity()+200))))
    ...
    public void run() {
        ...
        telemetry.addData("front shooter target velocity", Constants.FRONT_SHOOTER_VELOCITY.value+frontCount*50);
        telemetry.addData("front shooter velocity", shooter.frontShooter.getVelocity());
        telemetry.addData("back shooter target velocity", shooter.frontShooter.getVelocity()+200);
