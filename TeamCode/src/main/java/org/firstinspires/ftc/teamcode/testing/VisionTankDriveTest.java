...
public class VisionTankDriveTest extends LinearOpMode {
  static final double DESIRED_DISTANCE = 12.0;
  static final double SPEED_GAIN = 0.02;
  static final double TURN_GAIN = 0.01;

  static final double MAX_AUTO_SPEED = 1;
  static final double MAX_AUTO_TURN = 0.75;
  ...
  private static final int DESIRED_TAG_ID =
      100; // Choose the tag you want to approach or set to -1 for ANY tag.
