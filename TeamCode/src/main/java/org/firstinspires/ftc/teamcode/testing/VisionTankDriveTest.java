...
public class VisionTankDriveTest extends LinearOpMode {
    ...
    final static double SPEED_GAIN =   0.02 ;
    final static double TURN_GAIN  =   0.01 ;

    final static double MAX_AUTO_SPEED = 1;
    final static double MAX_AUTO_TURN  = 0.75;
    ...
    private static final int DESIRED_TAG_ID = 100;    // Choose the tag you want to approach or set to -1 for ANY tag.
